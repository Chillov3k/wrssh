...
func linkArgumentDescriptions() map[string]string {
	return map[string]string{
		...
		"execass":           "Compile the optional Windows-only execution-assist subsystem stub into the client",
...
func BuildOptionHelp() map[string]string {
	descriptions := linkArgumentDescriptions()
	keys := []string{
		"shared-object",
		"garble",
		"upx",
...
func (l *link) ValidArgs() map[string]string {
	...
	r := copyStringMap(linkArgumentDescriptions())
